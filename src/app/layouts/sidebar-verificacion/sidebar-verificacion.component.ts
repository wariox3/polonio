...
import { SIDEBAR_MENU, SidebarMenuItem } from './sidebar-verificacion-menu.config';

@Component({
  selector: 'app-sidebar-verificacion',
  standalone: true,
  imports: [RouterLink, RouterLinkActive, CommonModule],
  templateUrl: './sidebar-verificacion.component.html',
  styleUrl: './sidebar-verificacion.component.scss',
})
export class SidebarVerificacionComponent implements OnInit {
