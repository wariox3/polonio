...
@Component({
  selector: 'app-guia-pendiente-entrega',
  standalone: true,
  imports: [FiltroComponent, PaginadorComponent, TablaComponent],
  templateUrl: './guia-pendiente-entrega.component.html',
})
export default class GuiaPendienteEntregaComponent implements OnInit {
